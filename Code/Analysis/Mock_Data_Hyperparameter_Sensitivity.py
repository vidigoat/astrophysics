...
def main():
    ...
    checkpoint_path = os.path.join(RESULTS_DIR, 'mock_data_checkpoint.pkl')
    results_path_temp = os.path.join(RESULTS_DIR, 'mock_data_results_temp.csv')
