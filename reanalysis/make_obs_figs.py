...
SHORT={'ELPETRO_ABSMAG_R':'$M_r$','ELPETRO_MASS':r'$M_\star$','ELPETRO_TH50_R':r'$R_{50}$',
       'ELPETRO_BA':'$b/a$','ELPETRO_B300':'$b_{300}$','ELPETRO_METS':r'$Z_\star$',
       'COLOR_U_R':'$u-r$','SERSIC_N':'$n$','ZDIST':'$z$','logMH':r'$M_{\rm HI}$','W50':'$W_{50}$'}
