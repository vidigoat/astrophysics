...
if cut_info:
    ...
    print(
        f"    Removed {biggest_cut[1]:,} galaxies ({100*biggest_cut[1]/biggest_cut[2]:.1f}% of {biggest_cut[2]:,} galaxies before this cut)"
    )

output_file = os.path.join(
    os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "Data", "alfalfa_nsa_final_13props.pkl"
)
